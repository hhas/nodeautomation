...
function ConnectionError(number, targetID) { // TO DO: optional message parameter; e.g. see AppData.target(), which should raise this
    this.number = number;
    this.value = targetID;
    this.message = `Can't connect to application ${targetID}`; // TO DO: if targetID is file NSURL, show path only
}
