...
//            ["styledText", objc.typeStyledText],
...
//            ["internationalText", objc.typeIntlText],
            ...
            ["locationReference", objc.typeInsertionLoc],
            ["reference", objc.typeObjectSpecifier],
            ["alias", objc.typeAlias],
            ["fileRef", objc.typeFSRef], // no AS keyword
//            ["fileSpecification", objc.typeFSS],
...
//            ["missing value", objc.cMissingValue], // represented as null, not Keyword instance
    ...
    properties: [["class", objc.pClass],
                 ["id", objc.pID],
                 ["properties", _pALL],
    ],

    elements: [["items", objc.cObject],
// TO DO: what about ["text", objc.cText]?
    ],
