...
function Keyword(name, desc = null) { // either name or desc must be given (if desc is given, name is null)
    this.__nodeautomation_pack__ = function(appData) {
        return desc !== null ? desc : appData.typeDescriptorByName(name);
    };
    ...
    this.isEqual = function(value) {
        ...
        if (name !== null && name === value.__nodeautomation_keywordName__) { return true; }
        if (desc === null || value.__nodeautomation_rawDescriptor__ === null) { return false; }
...
function File(path) {
    ...
    this.toPath = function() { return this._path; };
    ...
    this.valueOf = this.inspect = this[Symbol.toPrimitive] = this.toString;
