...
class File {
	...
	constructor(path) {
		...
		this._path = path;
		this.#_desc = objc.NSAppleEventDescriptor.descriptorWithFileURL_(objc.NSURL.fileURLWithPath_(path));
    }
...
//    [Symbol.valueOf]() { return this._path; }
    ...
    [util.inspect.custom]() { return `(new File(${util.inspect(this._path)}))`; };
