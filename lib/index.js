...
// TO DO: k.normalizeKey() for converting UInt32 to same format used by record keys

const k = new Proxy({
    [util.inspect.custom]: () => 'k',
  }, {
...
function appRootFn() {} // Proxy requires the proxied object to be a function or it won't handle `apply`

appRootFn[util.inspect.custom] = () => 'app';
...
const appRoot = new Proxy(appRootFn, { // targetable/untargeted app root
  ...
  get: function(target, name) {
    ...
    case aesupport.__packSelf:
      return function(aeBuffer, appData) { // `app` root is typeNull descriptor
        aeBuffer.writeUInt32BE(kae.typeNull);
...
module.exports.con                      = aeappdata.untargetedConRoot;
module.exports.its                      = aeappdata.untargetedItsRoot;
module.exports.k                        = k;
module.exports.File                     = aesupport.File;
module.exports.CommandError             = aeerrors.CommandError;
module.exports.exportRawTerminology     = aegluetable.exportRawTerminology;
module.exports.__aesupport              = aesupport; // for debug use only
