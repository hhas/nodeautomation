...
function formatSpecifierRecord(appData, specifierRecord) { // TO DO: pass flag to indicate nesting
    ...
    case kae.formRelativePosition: // specifier.before/after(SYMBOL)
        ...
        if (specifierRecord.want) { // NSAppleEventDescriptor (previous/next element's type) // TO DO: this was ==function
    ...
    if (specifierRecord.want) { // NSAppleEventDescriptor (element[s] type) // TO DO: was =='function'
...
function formatValue(value) {
    ...
    } else if (typeof value === 'function' || objc.isObjC(value)) {
