...
function formatCommand(appData, commandDef, parentSpecifierRecord, parametersObject) {
    ...
    if (commandDef.name) {
        ...
        result += `.sendAppleEvent(${formatFourCharString(commandDef.eventClass)}, ${formatFourCharString(commandDef.eventID)}, `;
    }
...
function formatAppleEvent(appleEvent) {
    ...
    */
    ...
    if (commandDef) {
        ...
        result += `.sendAppleEvent(${formatFourCharString(eventClass)}, ${formatFourCharString(eventID)}, ${arg})`;
    }
    return result;
}
